...
export function Navbar() {
  const [setPopupShown, setPopupHidden] = useState("block");
  ...
  return (
    <div className="relative grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 min-h-0 w-full max-w-6xl mx-auto py-4 px-2 gap-1">
      ...
      <div className="col-span-2 text-[#191919] text-body flex flex-row justify-center">
        ...
        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="icon-div">about
          {/* <FaLinkedin className="size-5" /> */}
        </a>

        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="icon-div">view all
          {/* <FaLinkedin className="size-5" /> */}
        </a>
        ...
        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="icon-div">github
          {/* <FaLinkedin className="size-5" /> */}
        </a>
      </div>

      <div className="col-span-1 text-[#191919] text-body flex flex-row justify-center">
        <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="icon-div">contribute
          {/* <FaGithub className="size-5" /> */}
        </a>
      </div>
    </div>
