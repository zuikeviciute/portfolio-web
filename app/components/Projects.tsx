      ...
      <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="relative col-span-3 order-1">
          <a href={"https://github.com/zuikeviciute/portfolio-web"}>
                <img src={"unity.png"} alt="project image" className="object-cover h-56 w-full border-[#191919] border-2 rounded-lg hover:outline hover:outline-4 hover:outline-offset-0 outline-[#F17C60]" />
        ...
        <div className="relative lg:col-span-2 order-2">
          <a href={"https://github.com/zuikeviciute/portfolio-web"}>
                <img src={"vercel2.png"} alt="project image" className="object-cover h-56 w-full border-[#191919] border-2 rounded-lg hover:outline hover:outline-4 hover:outline-offset-0 outline-[#F17C60]" />
                <div className={"absolute left-2 bottom-1 flex flex-row justify-center items-center text-center text-sm font-medium bg-[#191919] p-1 rounded-lg text-white"}>
                    {/* <FaGithub color={"#ffffff"} /> */}
        ...
        <div className="relative col-span-3 order-4">
          <a href={"https://github.com/zuikeviciute/portfolio-web"}>
                <img src={"ux.png"} alt="project image" className="object-cover h-56 w-full border-[#191919] border-2 rounded-lg hover:outline hover:outline-4 hover:outline-offset-0 outline-[#BBC842]" />
                <div className={"absolute left-2 bottom-1 flex flex-row justify-center items-center text-center text-sm font-medium bg-[#191919] p-1 rounded-lg text-white"}>
                    {/* <FaGithub color={"#ffffff"} /> */}
        ...
        <div className="relative lg:col-span-2 col-span-3 order-5">
          <a href={"https://github.com/zuikeviciute/portfolio-web"}>
                <img src={"orms.png"} alt="project image" className="object-cover h-56 w-full border-[#191919] border-2 rounded-lg hover:outline hover:outline-4 hover:outline-offset-0 outline-[#BBC842]" />
                <div className={"absolute left-2 bottom-1 flex flex-row justify-center items-center text-center text-sm font-medium bg-[#191919] p-1 rounded-lg text-white"}>
                    {/* <FaGithub color={"#ffffff"} /> */}
