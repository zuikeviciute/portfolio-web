...
export function Tape() {
  return (
    <div className="relative">
      <div className="relative min-h-96 bg-[#191919] max-w-3xl mx-auto px-4"></div>
      ...
      <div className="absolute h-[98px] w-[160rem] left-[-740px] lg:left-[-240px] bottom-44 flex justify-left bg-[url('/static/images/about2.png')] rotate-[-6deg] border-4 border-[#191919]">
      </div>
    </div>
  );
}
